...
function zi(e, n, t, r, l) {
  ...
  if ((Gn(n, l), n.stateNode === null))
    xr(e, n), xa(n, t, r), ku(n, t, r, l), (r = !0);
  else if (e === null) {
    var o = n.stateNode,
      i = n.memoizedProps;
    o.props = i;
...
function ja(e) {
  ...
  n !== null && ((e.alternate = null), ja(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[At], delete n[vu], delete n[Kf], delete n[Yf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
hs = _o;
ys = zn;
var Pd = { usingClientEntryPoint: !1, Events: [Zt, Un, ll, ms, vs, _o] },
  ht = {
...
function Ld() {
  return On.jsxs(On.Fragment, {
    children: [
      On.jsx('h1', { children: 'React App' }),
      On.jsx('p', { children: 'React app with Vite' }),
    ],
  });
}
ec(document.getElementById('root')).render(
  On.jsx(Au.StrictMode, { children: On.jsx(Ld, {}) }),
);
